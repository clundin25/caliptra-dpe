...
// Not public since the number of handles may vary between implementations.
// Used by OpenSSL and RustCrypto implementations
#[allow(unused)]
...
pub trait Crypto {
    ...
    fn derive_key_pair_exported(
        &mut self,
        algs: AlgLen,
        exported_handle: &[u8; MAX_EXPORTED_CDI_SIZE],
        label: &[u8],
        info: &[u8],
    ) -> Result<(Self::PrivKey, EcdsaPub), CryptoError>;
